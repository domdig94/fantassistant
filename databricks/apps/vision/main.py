"""
FantAssistant Databricks — Vision App (FastAPI)

Identico a services/vision/main.py: il servizio non tocca il DB,
usa solo Azure OpenAI GPT-4.1 multimodale. Zero modifiche necessarie.
"""
import os
import base64
import json
...
app = FastAPI(title="FantAssistant Vision — Databricks")
